...
NEW = [
    'bash_scripts/explore_sqoop_rhs18_conv',
    'bash_scripts/explore_sqoop_rhs18_relnet',
    'bash_scripts/explore_sqoop_rhs18_workspace',
    'bash_scripts/explore_sqoop_rhs18_transformer',
    'bash_scripts/BASELINE_CHANGES.md',
    'conf/experiment/sqoop/baselines/ablations/transformer_patchify.yaml',
    'conf/experiment/sqoop/baselines/ablations/shared_workspace_patchify.yaml',
    'conf/experiment/sort_of_clevr/baselines/ablations/transformer_patchify.yaml',
    'conf/experiment/sort_of_clevr/baselines/ablations/shared_workspace_patchify.yaml',
    'verify/verify_ablations.py',
    'bash_scripts/final_sqoop_rhs35_syncnet',
    'bash_scripts/final_sqoop_rhs35_baselines',
    'bash_scripts/final_sqoop_rhs18_syncnet',
    'bash_scripts/final_sqoop_rhs18_baselines',
    'bash_scripts/final_sqoop_rhs08_syncnet',
    'bash_scripts/final_sqoop_rhs08_baselines',
    'bash_scripts/final_sqoop_rhs04_syncnet',
    'bash_scripts/final_sqoop_rhs04_baselines',
    'bash_scripts/final_sqoop_rhs02_syncnet',
    'bash_scripts/final_sqoop_rhs02_baselines',
    'bash_scripts/final_sqoop_rhs01_syncnet',
    'bash_scripts/final_sqoop_rhs01_baselines',
    'scripts/check_ablation_wiring.py',
    'bash_scripts/debug_ablations',
    'bash_scripts/final_sqoop_rhs01_sweeps',
    'bash_scripts/final_sqoop_rhs01_ablations',
    'bash_scripts/final_soc_syncnet',
    'bash_scripts/final_soc_baselines',
    'bash_scripts/run_soc_baseline_rescue',
